...
export const AVAILABLE_FONTS: FontOption[] = [
  ...
  { value: "toppan-bunkyu-midashi-min-st", label: "凸版文久見出し明朝 StdN", category: "japanese" },
  { value: "Toppan Bunkyu Mincho Regular", label: "凸版文久明朝 Regular", category: "japanese" },
  { value: "dnp-shuei-4gob-std", label: "DNP 秀英四号太かな Std", category: "japanese" },
  ...
  { value: "vdl-penletter", label: "VDL ペンレター M", category: "japanese" },
  ...
  { value: "vdl-logomarujr-pop-futoline", label: "VDL ロゴ丸Jr-pop FutoLine", category: "japanese" },
  { value: "vdl-logomarujr-pop-shadow", label: "VDL ロゴ丸Jr-pop Shadow", category: "japanese" },
  { value: "kinkakuji", label: "金畫字 Normal", category: "japanese" },
  { value: "genkaimincho", label: "源界明朝 Regular", category: "japanese" },
  { value: "train-one", label: "トレイン One Regular", category: "japanese" },
